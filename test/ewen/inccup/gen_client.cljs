...
(comment
  (let [comp (vdom/render! (utils/new-root) reconciliation-comp (clojure.core/list))]
    (reset! *key-counter* 0)
    (vdom/update! comp (clojure.core/list "" "" (ewen.inccup.gen-client/make-component-with-key) (ewen.inccup.gen-client/make-component-with-key)))
    (reset! *key-counter* 0)
    (vdom/update! comp (clojure.core/list (ewen.inccup.gen-client/make-component) ""))
